...
\plnote{Is it good to include the unit type under dependent sums?}
...
\todo{Section out of date, needs new pass.}

We will have one axiomatic cofibration, whose codomain is an axiomatic pre-type.
\begin{mathpar}
