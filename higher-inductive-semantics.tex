...
\[ \inferrule{\ }{\Gamma \vdash \ivl \type} \qquad 
...
\[ \inferrule{\Gamma, y:\ivl \vdash A \fib \\ \Gamma, x:2 \vdash a : A\subst{\copair{0}{1}(x)}{y}}{\Gamma \vdash \Big(\tsm{f : \tprd{y:\ivl} A} \tprd{x:\bool} \eq{f(i(x))}{a}\Big) \fib} \]
