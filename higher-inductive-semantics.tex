...
\begin{mathpar}
  \jd{}{\Gamma \cxt}
\and
  \jd{}{\sigma : \Gamma \to \Delta}
\and
  \jd{}{\sigma \jdeq \sigma' : \Gamma \to \Delta}
\and
  \jd{\Gamma}{A \fibtype}
\and
  \jd{\Gamma}{ A \pretype}
\and
  \jd{\Gamma}{ A \jdeq A' \pretype}
\and
  \jd{\Gamma}{ a : A}
\and
  \jd{\Gamma}{ a \jdeq a' : A}
...
\begin{mathpar}
  \inferrule{
    ...
    \Gamma \types a : A
  }{ \Gamma \types \extapp{f}{(\cofapp{i}{a})} \jdeq d\subst{a}{x} : C\subst{\cofapp{i}{a}}{y},}
\and
  \inferrule{
    \text{($\Gamma$, $A$, $B$, $i$, $C$, $d$, $c$, $f$ as in abstr and app rules)} \\
    \Gamma \types b : B
  }{ \Gamma \types \extapp{ (\extlam{y:B} c) }{b} \jdeq c\subst{b}{y} : C\subst{b}{y}. }
\and
  \text{\todo{TODO: an $\eta$-rule}}
\end{mathpar}
...
\begin{mathpar}
  \inferrule{ \jd{\Gamma, x,y:A, u:\id[A]{x}{y}}{C \pretype}
    \\ \jd{\Gamma, x:A }{ d_\refl : C\subst{x,x,\refl_x}{x,y,u}}}
  { \jd{\Gamma, a,b:A, p:\id[A]{a}{b} }{ J(\dots,p) : C\subst{a,b,p}{x,y,u}}  }
\and
...
\begin{proof}
  ...
  % we want to extend the $\freemonad{ \poly f \times A}$-structure of $E$ to a $\freemonad{\poly f \times B}$-structure such that $p$ is a $\freemonad{\poly f \times B}$-algebra map.
...
\todo{Remark that elements of initial algebras can be reformulated as transformations between polynomial functors.}
