...
\usepackage[mode=multiuser,layout=margin,status=final]{fixme}
...
\ifmpcps
  ...
  \defrmk{defn}{Definition}{Definitions}
  \defrmk{rmk}{Remark}{Remarks}
  \defrmk{eg}{Example}{Examples}
  \defrmk{noneg}{Non-example}{Non-examples}
  \defrmk{egs}{Examples}{Examples}
  \defrmk{notes}{Notes}{Notes}
\else
  \newenvironment{constr}{\begin{proof}[Construction]}{\end{proof}}
  \theoremstyle{definition}
  ...
  \defthm{noneg}{Non-example}{Non-examples}
