...
\begin{abstract}
  ...
  More precisely, we introduce the notion of \emph{cell monads with parameters}: a semantically-defined scheme for specifying homotopically well-behaved notions of structure.
  %
  ...
  %
  Meanwhile, model categories to which the construction applies include sets, groupoids, and simplicial sets.
\end{abstract}
...
Moreover, we expect cell monads with parameters to suffice for obtaining many other higher inductive types, under the limitation that constructors cannot involve “fibrant structure”, i.e.\ eliminations into the higher inductive type itself.
