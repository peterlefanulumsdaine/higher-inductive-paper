...
\begin{rmk}
The first version of this paper omitted the condition that good model categories should be \emph{simplicially} locally cartesian closed, required for copowers to be stable under pullback.
It seems possible this condition may be automatic, at least for Cisinski model categories, but this is not clear to the authors; see \cite{MO:enriched-cccs}.    
\end{rmk}
