...
Moreover, we expect parametrized cell monads to suffice for obtaining many other higher inductive types, under the limitation that constructors cannot involve “fibrant structure”, i.e.\ eliminations into the higher inductive type itself.
