...
For any diagram $\Theta:\I\to\C$ with \I finite and inverse, the \textbf{matching object} at $x\in\I$ is the limit $M_x\Theta = \lim_{y\in x\sslash\I} \Theta(y)$ (if it exists), where $x\sslash \I$ is the full subcategory of the co-slice $x/\I$ that omits the identity $1_x$.
