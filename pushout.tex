...
\begin{defn}
  ...
  \end{enumerate}
  An \textbf{excellent\footnote{Note that this nonce definition is different from the similarly-named one of~\cite[Definition A.3.2.16]{lurie:higher-topoi}, though it does share some of the same axioms.} model category} is a good model category that is in addition combinatorial, i.e.\ it satisfies the following further properties.
